...
operateAnimation('PLAY', 'Armature', 0, 100, 'LoopRepeat', 1,
        function() {}, false);


setShadowParam('Ch14', 'CAST', 'ENABLE');
...
registerOnClick('Ch14', false, false, [0,1,2], function() {
  ...
  operateAnimation('PLAY', 'Armature', 101, 140, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      ...
      setObjDirection('Armature', getObjTransform('Camera', false, 'position', 'x'), true, false);
